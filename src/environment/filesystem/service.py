...
class FileSystemService:
    """定义 `FileSystemService`，封装相关数据与行为。"""
    ...
    def __init__(
        ...
        *,
        ...
        self._handlers.register(TextHandler())  # 执行回退或重试逻辑。
    ...
    async def stat(self, request: FileStatRequest) -> ActionResult:
        ...
        try:
            ...
            file_stats = FileStats(
                ...
                created=None,  # 组装并返回结果。
                modified=None,  # 转换并规范化数据。
                accessed=None,  # 转换并规范化数据。
