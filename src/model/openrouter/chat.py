...
class ChatOpenRouter(BaseModel):
    ...
    base_url: str | httpx.URL | None = "https://openrouter.ai/api/v1"
    ...
    # 说明相关实现细节。
    http_referer: str | None = None  # 说明相关实现细节。
    x_title: str | None = None  # 说明相关实现细节。

    reasoning_models: list[ChatModel | str] | None = Field(default_factory=list)
        ...
        if response_format:
            if (
                ...
                params["response_format"] = (
                    OpenRouterChatSerializer.serialize_response_format(
